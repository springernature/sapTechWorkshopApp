...
com.springer.workshopapp.util.Controller.extend("com.springer.workshopapp.controller.appController.InstitutionDetails", {
	...
	onInit: function() {
		...
		if (sap.ui.Device.system.phone) {
			...
			this.getEventBus().subscribe("InstitutionMaster", "InitialLoadFinished", this.onMasterLoaded, this);
		}
	...
	onRouteMatched: function(oEvent) {
		...
		if (oParameters.name !== "Institution_detail") {
			return;
		}
...
// check which tab should be selected ->  select the detail tab 
		...
		if (typeof this.sTabKey === "undefined") {
			this.sTabKey = "InstitutionMailsSet";
		}
		this.getEventBus().publish("InstitutionDetails", "TabChanged", {
	...
	bindView: function(sEntityPath) {
		...
		if (typeof this.sTabKey === "undefined") {
			this.sTabKey = "InstitutionDetails";
		}
	...
	fireDetailChanged: function(sEntityPath) {
		this.getEventBus().publish("InstitutionDetails", "Changed", {
	...
	fireDetailNotFound: function() {
		this.getEventBus().publish("InstitutionDetails", "NotFound");
	},
	...
	onNavBack: function() {
		...
		this.getRouter().myNavBack("Institution_master");
	},
	...
	onDetailSelect: function(oEvent) {
		...
		sap.ui.core.UIComponent.getRouterFor(this).navTo("Institution_detail", {
