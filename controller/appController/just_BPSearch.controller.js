...
com.springer.workshopapp.util.Controller.extend("com.springer.workshopapp.controller.appController.just_BPSearch", {
	...
	onRouteMatched: function(evt) {
		...
		if (evt.getParameter("name") !== "_just_BPSearch") {
			return;
		}
	...
	onAfterShow: function() {
		...
		this.jsonAppModel.currentScreen = "just_BPSearch";
