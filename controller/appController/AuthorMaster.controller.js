...
com.springer.workshopapp.util.Controller.extend("com.springer.workshopapp.controller.appController.AuthorMaster", {
	...
	onInit: function() {
		...
		this.getView().byId("AuthorMasterList").attachEventOnce("updateFinished", function() {
			this.oInitialLoadFinishedDeferred.resolve();
			oEventBus.publish("AuthorMaster", "InitialLoadFinished", {
				oListItem: this.getView().byId("AuthorMasterList").getItems()[0]
			});
		}, this);

		oEventBus.subscribe("AuthorDetails", "TabChanged", this.onDetailTabChanged, this);
		...
		oEventBus.subscribe("AuthorDetails", "Changed", this.onDetailChanged, this);
		oEventBus.subscribe("AuthorDetails", "NotFound", this.onNotFound, this);
	},
	...
	onRouteMatched: function(oEvent) {
		...
		this.getRouter().myNavToWithoutHash({
			...
			targetViewName: "com.springer.workshopapp.view.appViews.AuthorDetails",
			targetViewType: "XML"
		});
	...
	onAfterShow: function() {
		...
		this.jsonAppModel.currentScreen = "AuthorApp";
	...
	onDetailChanged: function(sChanel, sEvent, oData) {
		...
		//Wait for the list to be loaded once
		this.waitForInitialListLoading(function() {
			var oList = this.getView().byId("AuthorMasterList");
	 ...
	 */
	onNotFound: function() {
		this.getView().byId("AuthorMasterList").removeSelections();
	},
	...
	onSearch: function() {
		...
		// update list binding
		var list = this.getView().byId("AuthorMasterList");
	...
	showDetail: function(oItem) {
		...
		this.getRouter().navTo("Author_detail", {
			from: "Author_master",
